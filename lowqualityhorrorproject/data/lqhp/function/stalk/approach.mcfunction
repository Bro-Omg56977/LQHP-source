...
execute as @e[tag=lowqualityhorrorproject] at @s if score @s lqhp.soundsrandomizer.2 matches 1 run summon wither_skeleton ~20 ~50 ~-18 {Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Tags:["lqhpstalker"],active_effects:[{id:slow_falling,duration:200,amplifier:1,show_particles:0b},{id:slowness,duration:999999,amplifier:2,show_particles:0b}]}
...
execute as @e[tag=lqhpstalker] run function lqhp:stalk/check_approach
